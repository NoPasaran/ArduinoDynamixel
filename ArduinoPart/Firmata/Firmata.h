...
// callback function types
    ...
    typedef void (*dynamixelCallbackFunction) (byte command, byte idmessage, byte argc, byte*argv);
}
...
/* attach & detach callback functions to messages */
    ...
    void attach(byte command, dynamixelCallbackFunction newFunction);
...
/* callback functions */
    ...
    dynamixelCallbackFunction currentDynamixelCallback;
/* private methods ------------------------------ */
